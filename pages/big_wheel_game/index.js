          ...
          awards: [
            {
              id: 0,
              name: "键盘",  // 选项名
              color: '#ffcb3f',         // 选项的背景颜色
              probability: 10,       // 概率 0代表永远也转不到这个选项，数字越大概率也就越大
              icon: "http://image1.sansancloud.com/xianhua/2018_12/6/17/45/49_767.jpg?x-oss-process=style/preview_120",
            },
            {
              id: 1,
              name: "鼠标", // 超过9个字时字体会变小点
              color: '#ffcb3f',
              probability: 10,
              icon:"http://image1.sansancloud.com/xianhua/2018_12/6/17/45/49_789.jpg?x-oss-process=style/preview_120",
            }, 
            {
              id: 1,
              name: "耳机", // 超过9个字时字体会变小点
              color: '#ffcb3f',
              probability: 10,
              icon: "http://image1.sansancloud.com/xianhua/2018_12/6/17/45/49_771.jpg?x-oss-process=style/preview_120",
            }, {
              id: 0,
              name: "键盘",  // 选项名
              color: '#ffcb3f',         // 选项的背景颜色
